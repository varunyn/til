        ...
        <div className="flex flex-col items-center justify-between sm:flex-row">
          <div className="mb-4 flex items-center space-x-4 sm:mb-0">
            <a
              ...
              className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center p-2 transition-colors hover:text-sorbus-600 focus:outline-none focus:ring-2 focus:ring-sorbus-500 focus:ring-offset-2 dark:hover:text-sorbus-400"
